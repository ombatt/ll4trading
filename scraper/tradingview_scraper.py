...
url_str = "https://it.tradingview.com/symbols/NYMEX-CL1!/news/"  # "https://finance.yahoo.com/quote/CL=F/" https://finance.yahoo.com/quote/CL%3DF/news/

'''
NON ANCORA UTILIZZATO. DA CAPIRE COME GESTIRE L?ACCOUNT
'''
...
class YahooScraper(Scraper):
    ...
    def search_for_news(self) -> list[News]:
        ...
        news_container = soup.find('div', {'data-container-name': 'symbol-page-news-section'})
        news = news_container.find_all('article')
